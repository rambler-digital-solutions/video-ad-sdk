import {VastIcon as BaseVastIcon} from '../../../vastSelectors'
...
interface VastIcon extends BaseVastIcon {
  [firstRenderPending]?: boolean
}

const hasPendingIconRedraws = (icons: VastIcon[], videoElement: HTMLVideoElement): boolean => {
...
const removeDrawnIcons = (icons: VastIcon[]): void => icons
...
interface AddedIcons {
  ...
  hasPendingIconRedraws(icons: VastIcon[], videoElement: HTMLVideoElement): boolean
  removeIcons(icons: VastIcon[]): void
}

const addIcons = (icons: VastIcon[], {videoAdContainer, onIconView = noop, onIconClick = noop, ...rest}: AddIconsOptions = {}): AddedIcons => {
