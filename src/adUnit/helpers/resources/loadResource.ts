...
interface LoadRecourceOptions {
  document: Document
  placeholder: HTMLElement
}

type Resource = HTMLDivElement | HTMLIFrameElement | HTMLImageElement

const noop = (): void => {};
const loadResource = (icon: VastIcon, {document, placeholder}: LoadRecourceOptions): Promise<Resource> => new Promise<Resource>((resolve, reject) => {
  try {
